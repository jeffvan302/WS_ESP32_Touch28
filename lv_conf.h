...
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'S'      /**< Drive letter for SD card via ESP-IDF VFS */
    #define LV_FS_STDIO_PATH "/sdcard"  /**< SD_MMC mount point */
    #define LV_FS_STDIO_CACHE_SIZE 512  /**< Read-ahead cache for smoother image loading */
#endif
...
/** LODEPNG decoder library (built into LVGL, no external dependency) */
